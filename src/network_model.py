...
# Truncated Network model class, that terminates at the Dense layer with 50 outputs
class TruncatedNetworkThree(nn.Module):
    def __init__(self) -> None:
        super(TruncatedNetworkThree, self).__init__()
        # A convolution layer with in_channels, out_channels, and kernel_size
        self.conv1 = nn.Conv2d(1, 10, kernel_size=5)
        # A max pooling layer with a 2x2 window and a ReLU function applied.
        self.conv2 = nn.Conv2d(10, 20, kernel_size=5)
